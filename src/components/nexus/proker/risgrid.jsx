...
const prokerList = [
  {
    title: "HACKATHON",
    desc: "Sebuah acara atau kompetisi yang melibatkan para programmer, pengembang perangkat lunak, desainer, dan individu lain yang memiliki keahlian terkait teknologi untuk bekerja sama dalam tim.",
    img: Hackathon,
  },
  {
    title: "FTI TECH RESEARCH HUB",
    desc: "Mengumpulkan dan membangun database tugas akhir dan skripsi mahasiswa tingkat akhir di FTI UNAND.",
    img: TechHub,
    googledrive:
      "https://drive.google.com/drive/folders/1tnkRJlvPzm-VAqRv1HAohzLNmHD-vtsF?hl=id",
  },
  {
    title: "IT SPECTRUM",
    desc: "Penyampaian informasi terkini dan ilmu pengetahuan serta fakta - fakta menarik seputar dunia teknologi informasi melalui platform media sosial.",
    img: [ITSpectrum, ITSpectrum1, ITSpectrum2],
  },
  {
    title: "ITALK",
    desc: "Penyampaian informasi terkini dan ilmu pengetahuan serta fakta - fakta menarik seputar dunia teknologi informasi melalui platform media sosial.",
    img: Italk,
    spotify:
      "https://open.spotify.com/show/43nlPCgOfkVfcKuma08qfd?si=dcd873be6c214d44",
  },
  {
    title: "COMPETEHUB",
