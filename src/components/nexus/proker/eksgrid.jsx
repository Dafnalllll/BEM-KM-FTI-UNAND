...
const prokerList = [
  {
    title: "BEM VISIT",
    desc: "Memperkenalkan FTI serta menjalin silaturahmi dengan BEM KM Fakultas lain, baik di lingkungan UNAND maupun di luar UNAND.",
    img: [BemVisit, BemVisit1],
  },
  {
  ...
  {
    title: "MEDIA PARTNER",
    desc: "Menjalin kerja sama dengan lembaga atau panitia lain dan mendapat benefit dari kerja sama yang telah dilakukan.",
    img: [MedPart, MedPart1, MedPart2],
  },
  {
  ...
  {
    title: "TECHNOFEST",
    desc: "Merayakan ulang tahun FTI dengan mengadakan lomba untuk siswa SLTA, termasuk olimpiade komputer, cerdas cermat, karya tulis ilmiah, dan desain grafis. Akan dibentuk kepanitiaan dari KM FTI untuk menyusun acara.",
    img: Technofest,
  },
];
