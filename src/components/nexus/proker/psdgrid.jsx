...
const prokerList = [
  {
    title: "NEXMUD",
    desc: "Sekolah kepemimpinan untuk mahasiswa baru FTI agar bisa merasakan kehidupan berorganisasi di BEM KM FTI, dimana didalamnya terdapat serangkaian kegiatan yang meliputi: Pemberian materi, Simulasi, FGD serta magang di kedinasan masing-masing dengan SOP yang telah ditetapkan.",
    img: Nexmud,
  },
  {
    title: "LKMM-TD FTI",
  ...
  {
    title: "EDUNEX",
    desc: "Pelatihan dengan simulasi interaktif untuk Mahasiswa FTI sebagai persiapan menjadi mahasiswa berprestasi dan/atau sebagai bekal kehidupan pasca sarjana (Kuliah S2 dan dunia pekerjaan) dengan mitra terkait sebagai salah satu support system.",
    img: Sekawan,
  },
  {
    title: "FAA",
    desc: "Ajang pemilihan serta penghargaan kepada mahasiswa FTI yang telah meraih prestasi.",
    img: FAA,
  },
  {
    title: "WISUDA FTI DAN BAK ",
    desc: "Menyusun dan melaksanakan acara wisuda yang terstruktur dan pemberian penghargaan kepada mahasiswa yang telah mengabdikan diri di bidang organisasi kampus melalui seleksi nama-nama calon bintang aktivis berdasarkan azas keterwakilan dari individu mahasiswa ataupun unit kegiatan mahasiswa di tingkat fakultas.",
    img: WisudaBak,
  },
];
