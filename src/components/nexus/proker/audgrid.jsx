...
const prokerList = [
  {
    title: "NEXUS SHIFTERS",
    desc: "Menjaga kebersihan dan kerapian ruang kesekretariatan BEM KM FTI UNAND.",
    img: NexusShifter,
  },
  {
    title: "NEXUS ARCHIVE",
    desc: "Mengetahui surat masuk dan surat keluar selama kepengurusan menggunakan Microsoft Excel dan Buku Surat yang telah tersedia di sekre BEM KM FTI UNAND serta melakukan pengelolaan inventaris BEM KM FTI UNAND selama kepengurusan.",
    img: NexusArchive,
  },
  {
    title: "INSPIRASI UPGRADE",
    desc: "Untuk meningkatkan mutu, pengetahuan, dan ilmu organisasi bagi pengurus BEM KM FTI UNAND 2025. Serta agar pengurus menyadari fungsi dalam kepengurusan dan untuk membangun semangat kepengurusan.",
    img: InspirasiUpgrade,
  },
  {
    title: "SOP & PAP ",
    desc: "Untuk menghandle setiap pengurus dinas/biro, terkait keaktifannya dalam menjalankan proker, serta mempertimbangkan kelanjutan atas pengurus yang tidak aktif melalui diskusi bersama.",
    img: SOPPAP,
    googledrive:
      "https://drive.google.com/drive/folders/1Ux6R-dFjoqix_XCX5ukIZvdhkG49kiz9",
  },
  {
    title: "EVALUASI PENGURUS",
    desc: "Untuk memberikan evaluasi terhadap progress proker yang terlaksana dari setiap dinas dalam BEM KM FTI UNAND 2025.",
    img: EvalPengurus,
  },
  {
    title: "FUN TIME",
  ...
  {
    title: "SOTM",
    desc: "Untuk menghargai kinerja dan memberikan penilaian atas pencapaian pengurus BEM KM FTI UNAND 2025.",
    img: SOTM,
  },
  {
    title: "PERPISAHAN PENGURUS",
    desc: "Mengucapkan rasa terimakasih kepada para pengurus yang telah menjalani tugas dan amanah selama kepengurusan.",
    img: PerpisahanPengurus,
  },
  {
    title: "SERTIFIKAT PENGURUS ",
    desc: "Sebagai bentuk penghargaan kepada seluruh pengurus BEM KM FTI UNAND atas kinerja dan kontribusinya dalam kepengurusan.",
    img: SertifikatPengurus,
  },
];
