...
const data = [
  ...
  {
    title: "POV (Proud Of Value)",
    desc: "Memberikan reward kepada pengurus yang terpilih dilihat dari kinerjanya.",
  },
  {
    title: "PAP(Pemantauan Aktivitas Pengurus) & SOP PENGURUS",
...
const AIProkerGrid = () => (
  <div className="w-full px-4 py-8 mt-12">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 cursor-pointer">
      {data.map((item, idx) => (
        <div key={idx} data-aos="fade-up" data-aos-delay={idx * 80} className="h-full">
