...
const data = [
  {
    title: "SINERGI SHIFTERS",
    desc: "Membuat jadwal piket untuk setiap pengurus setiap harinya.",
  },
  {
    title: "ARKASURA",
    desc: "Merekam surat masuk & keluar BEM KM FTI Unand dan melakukan koordinasi dengan sekretaris dan seluruh pengurus BEM mengenai surat masuk dan surat keluar.",
  },
  {
    title: "MONTHLY TIMELINE SINERGI",
    desc: "Menghimpun setiap kegiatan yang dilakukan oleh dinas maupun biro.",
  },
  {
    title: "BE SECRETARY",
    desc: "Mengadakan Webinar dalam bidang kesekretariatan.",
  },
  {
    title: "ARCHIVE",
    desc: "Membuat dokumentasi kegiatan seluruh Dinas dan Biro BEM KM FTI kedalam suatu buku dokumentasi berupa album.",
  },
  {
    title: "SERTIFIKAT PENGURUS",
    desc: "Membuat dan memberikan sertifikat kepengurusan kepada setiap pengurus.",
  },
  {
    title: "PEMBUATAN DAN SOSIALISASI SOP",
    desc: "Pembuatan SOP administrasi BEM KM FTI UNAND dan mengadakan sosialisasi SOP administrasi surat yang telah dibuat kepada sekretaris dinas/biro BEM KM FTI UNAND",
  },
];

const KestariProkerGrid = () => (
...
export default KestariProkerGrid;
