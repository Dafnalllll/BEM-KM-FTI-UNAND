...
import Dhiya from "../../../assets/dinassinergi/press release/bistech/dhiya.webp";
import Niken from "../../../assets/dinassinergi/press release/bistech/niken.webp";
import Heni from "../../../assets/dinassinergi/staff release/bistech/heni.webp";
import Suci from "../../../assets/dinassinergi/staff release/bistech/suci.webp";
import Ridho from "../../../assets/dinassinergi/staff release/bistech/ridho.webp";
import Aihaf from "../../../assets/dinassinergi/staff release/bistech/aihaf.webp";
import { FaInstagram, FaLinkedin } from "react-icons/fa";

const eksekutifList = [
  {
    name: "Ghifari Rizki Ramadhan",
    photo: Ghifari,
    desc: "Kepala Dinas",
    jurusan: "Sistem Informasi 2022",
    instagram: "https://www.instagram.com/_ghifariramadhan/",
    linkedin: "https://www.linkedin.com/in/ghifari-rizki-ramadhan-42416829a/",
  },
  {
    name: "Dhiya Gustita Aqila",
    photo: Dhiya,
    desc: "Sekretaris",
    jurusan: "Sistem Informasi 2022",
    instagram: "https://www.instagram.com/dhiyaql/",
    linkedin: "https://www.linkedin.com/in/dhiyaqila/",
  },
  {
    name: "Heni Yunida",
    photo: Heni,
    desc: "Staff Ahli",
    jurusan: "Sistem Informasi 2022",
    instagram: "https://www.instagram.com/heniyunidaa/",
    linkedin: "https://www.linkedin.com/in/heni-yunida-8674322a1/",
  },
  {
    name: "Niken Khalilah Hamuti",
    photo: Niken,
    desc: "Bendahara",
    jurusan: "Sistem Informasi 2022",
    instagram: "https://www.instagram.com/nikenkhalilah/",
    linkedin: "https://www.linkedin.com/in/niken-khalilah-hamuti-0b5b612a6/",
  },
  {
    name: "Suci Nurhaliza",
    photo: Suci,
  ...
  },
  {
    ...
    instagram: "https://www.instagram.com/ridho.afan/",
    linkedin: "https://www.linkedin.com/in/ridho-a-52ab2312a/",
  },
  {
    name: "Aihaf Nathiqa Zihnan",
    photo: Aihaf,
    desc: "Staff Ahli",
    jurusan: "Teknik Komputer 2022",
    instagram: "https://www.instagram.com/aihafnz/",
    linkedin: "https://www.linkedin.com/in/aihafnathiqa/",
  },
];

const BistechSinergi = () => {
  useEffect(() => {
    document.title = "Bistech || Sinergi";
  }, []);
  return (
    <div
      ...
      <div className="min-h-screen flex flex-col items-center justify-start bg-black/60  py-10">
        ...
        >
          ...
          <div className="max-w-xl mx-auto text-white text-xl font-serif font-medium italic mt-6 mb-4">
            ...
            dengan menciptakan peluang bisnis yang inovatif.
          </div>
        </div>
        {/* Eksekutif */}
        <div
