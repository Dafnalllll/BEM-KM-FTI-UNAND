...
const ukmList = [
  ...
  // Tambahkan UKM lain sesuai kebutuhan
  {
    nama: "MAPALA TECTONA",
    deskripsi:
  ...
  return (
    <div className="min-h-screen py-12 px-4 ">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-extrabold text-center text-green-800 mb-4 drop-shadow-lg tracking-wide">
          UKM FTI UNAND
        </h1>
          ...
          {ukmList.map((ukm, idx) => (
            <div
              ...
              style={{
                ...
                minHeight: "220px", // agar tetap proporsional di layar kecil
              }}
            >
              <div
